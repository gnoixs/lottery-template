...
<div>
  <header class="color1">
    ...
    <div>
      <i style="font-size:18px" class="icon iconfont icon-hanbaobao" @click='open'></i>
      <ul @click="close_showha" v-show="showha">
        <li @click="regulation">规则</li>
        <li @click="gotoTrendAddress">开奖</li>
        <!-- <li>走势</li> -->
      </ul>
    </div>
  </header>
<transition name="fade">
  ...
  <div v-show="isShow" class="header-is-active" @click="hideDailog">
    ...
    <div class="header-modal-content">
      ...
      <ul v-for="(v,k) in lotteryGame">
        <li @click='gotoAddress(k)'>{{v}}</li>
      </ul>
...
export default {
  data() {
    return {
      showha:false,
      isShow: false,
      lotteryGame:{game_55:"北京PK10",game_40:"重庆时时彩",game_35:"幸运飞艇",game_30:"广东快乐十分",game_25:"重庆幸运农场",game_20:"香港六合彩",game_15:"幸运28"}
    }
  },
  props: {
    game_code:{
